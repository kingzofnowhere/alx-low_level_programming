...
/**
 * check_elf - Check if file is a elf.
 * @e_ident: A pointer that points to an array containing the elf magic numbers.
 *
 * Des: If file is not an ELF file - exit code 98.
 */
 ...
 * @e_ident: A pointer that points to an array containing the elf magic numbers.
 *
 * Des: Magic numbers are separated by spaces.
 */
 ...
 *
 * Des: If the file cannot be closed - exit code 98.
 */
